...
from core.database import engine, DATABASE_URL, text, utcnow_naive, logger, AUTH_FILE, MEMORY_FILE, USER_PREFS_FILE, SETTINGS_FILE
...
ALL_MIGRATIONS = [
    ("model_endpoints", _migrate_model_endpoints),
