"""Model/Cookbook tools — endpoint registry, downloads, serves, cache inspection."""
import asyncio
import json
import os
import re
...
from src.tool_implementations.app_api import _internal_headers
...
async def do_adopt_served_model(content: str, owner: Optional[str] = None) -> Dict:
    ...
    if add_endpoint:
        ...
        try:
            from src.tool_implementations.models import do_manage_endpoints  # avoid forward ref issues
        except Exception:
